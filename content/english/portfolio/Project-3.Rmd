...
TNG <- read_csv("C://Users/jacob/Documents/KUK_2/content/Data/TNG.csv", 
...
### DS9 ###
DS9 <- read_csv("C://Users/jacob/Documents/KUK_2/content/Data/DS9.csv", 
                col_types = cols(X1 = col_skip()))
...
### VOY ###
VOY <- read_csv("C://Users/jacob/Documents/KUK_2/content/Data/vOY.csv", 
                col_types = cols(X1 = col_skip()))
...
### TOS ###
TOS <- read_csv("C://Users/jacob/Documents/KUK_2/content/Data/TOS.csv", 
                col_types = cols(X1 = col_skip()))
